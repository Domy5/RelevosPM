...
//      Intent intent = new Intent(android.content.Intent.ACTION_VIEW);
    ...
    public static void getPackagesInicio(Context cont, int VerCode) {

        cc = cont;

        Toast.makeText(cc, " vc "+ Integer.toString(VerCode)+" vcapp "+Integer.toString(versionCodeApp), Toast.LENGTH_LONG).show();


                if (VerCode > versionCodeApp) {
