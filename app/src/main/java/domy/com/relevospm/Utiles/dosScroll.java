...
public class dosScroll extends FrameLayout {
    ...
    public dosScroll(Context context) {
        super(context);
        initTwoDScrollView();
    }

    public dosScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
        initTwoDScrollView();
    }

    public dosScroll(Context context, AttributeSet attrs, int defStyle) {
     ...
     *
     * @param direction_horz y direction_vert  the scroll direction: {@link android.view.View#FOCUS_UP} to go
    ...
    private int clamp(int n, int my, int child) {
        if (my >= child || n < 0) {             /*              * my >= child is this case: |--------------- me ---------------|
             * |------ child ------| or |--------------- me ---------------|
             * |------ child ------| or |--------------- me ---------------|
             * |------ child ------|
             *
